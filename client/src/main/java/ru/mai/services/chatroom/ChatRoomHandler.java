    ...
    public static Pair<Integer, Integer> getKeyAndBlockLength(Algorithm algorithm) {
        return switch (algorithm) {
            ...
            case ALGORITHM_RIJNDAEL ->
                    new Pair<>(AlgorithmsConfigs.RIJNDAEL_KEY_LENGTH, AlgorithmsConfigs.RIJNDAEL_BLOCK_LENGTH);
            case ALGORITHM_RC6 -> new Pair<>(AlgorithmsConfigs.RC6_KEY_LENGTH, AlgorithmsConfigs.RC6_BLOCK_LENGTH);
            case ALGORITHM_LOKI97 ->
                    new Pair<>(AlgorithmsConfigs.LOKI97_KEY_LENGTH, AlgorithmsConfigs.LOKI97_BLOCK_LENGTH);
